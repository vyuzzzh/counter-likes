...
router.get('/reg', (req, res, next) => {
  ...
  const url = `https://oauth.vk.com/access_token?client_id=7327798&client_secret=KVv5burkbNpWD5qLKyIt&redirect_uri=http://counter-likes.herokuapp.com/auth/reg/&code=${code}`;
